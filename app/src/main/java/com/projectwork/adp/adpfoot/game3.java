...
public class game3 extends android.support.v4.app.Fragment {
Button ans;
RadioButton a;
RadioGroup radioGroup;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.game_test_fragment3,container,false);
                ...
                if (text.contains("four")) {
                    if (mp != null ) {
                        if (!mp.isPlaying()) {
                           ...
                           game4 newGamefragment = new game4();
