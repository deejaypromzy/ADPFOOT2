...
public class game6 extends android.support.v4.app.Fragment {
Button ans;
RadioButton a;
RadioGroup radioGroup;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.game_test_fragment6,container,false);
