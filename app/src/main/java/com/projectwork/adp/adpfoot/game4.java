...
public class game4 extends android.support.v4.app.Fragment {
Button ans;
RadioButton a;
RadioGroup radioGroup;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.game_test_fragment4,container,false);
                ...
                if (text.contains("ENG")) {
                    if (mp != null ) {
                        if (!mp.isPlaying()) {
                           ...
                           game5 newGamefragment = new game5();
