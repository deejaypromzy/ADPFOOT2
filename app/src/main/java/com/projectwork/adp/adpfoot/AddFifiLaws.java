...
public class AddFifiLaws extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_fifi_laws);
        ...
        switch (v.getId()) {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(AddFifiLaws.this, "Error Updating , Check Internet Connectivity", Toast.LENGTH_SHORT).show();
                            }
                        })
            ...
            case R.id.imgBtn:
                ...
                if (storageTask != null && storageTask.isInProgress()) {
                    Toast.makeText(AddFifiLaws.this, "Uploading picture.....", Toast.LENGTH_SHORT).show();
    ...
    boolean NoPermissions() {
        ...
        for (String s : permissions) {
            res = AddFifiLaws.this.checkCallingOrSelfPermission(s);
