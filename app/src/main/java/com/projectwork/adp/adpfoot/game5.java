...
public class game5 extends android.support.v4.app.Fragment {
Button ans;
RadioButton a;
RadioGroup radioGroup;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.game_test_fragment5,container,false);
...
if (text==null) {
    ...
    return;
                ...
                if (text.contains("Juventus")) {
                    if (mp != null ) {
                        if (!mp.isPlaying()) {
                            mp.start();

                           game6 newGamefragment = new game6();
